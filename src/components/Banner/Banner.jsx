...
const Banner = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100">
      <h2 className="mt-15 text-center text-6xl font-bold">
        We Build
        <br />
        <span className="text-[#9F62F2]"> Productive </span> Apps
      </h2>
      <p className="text-[#627382] text-center mt-4">
      ...
      <div className="flex my-10 gap-4">
        <a
          className="flex btn py-6 px-5"
          href="https://play.google.com/store/apps?hl=en-us"
        >
          <img src={playStore} alt="" className="w-8 h-8" /> Google Play
        </a>
        <a
          className="flex btn py-6 px-5 "
